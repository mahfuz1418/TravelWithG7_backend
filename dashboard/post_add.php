    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="card widget widget-list">
                ...
                <div class="card-body">
                    <form method="POST" action="./post_add_data.php" enctype="multipart/form-data">

                        <!-- change name field  -->
                        <h5 class="text-center bg-info text-white p-2">Add new post</h5>
                        <div class="row mb-3">
                            <label for="title" class="col-form-label">Post Title</label>
                            <div>
                                <input type="text" class="form-control" name="post_title" id="" placeholder="Enter Post Title">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="des" class="col-form-label">Post Description</label>
                            <div>
                                <textarea class="form-control" name="post_description" id="" cols="30" rows="5" placeholder="Enter Post Description Here"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <button type="submit" class="btn btn-primary" name="add_guide">Add Post</button>
                            </div>
                            <div class="col-2"></div>
                            <div class="col-6">
                                <?php
